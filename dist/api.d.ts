 ...
 * @enum {string}
 */
export declare enum AccountDisplayNameEnum {
 ...
 * @enum {string}
 */
export declare enum AccountClearingStatusEnum {
    O = "O",
    P = "P",
    N = "N",
    A = "A",
 ...
 * @enum {string}
 */
export declare enum InlineObject11FreqEnum {
    D = "D",
    M = "M",
    Q = "Q"
}
 ...
 * @enum {string}
 */
export declare enum InlineObject4FiltersEnum {
    Inactive = "inactive",
 ...
 * @enum {string}
 */
export declare enum InlineResponse20016OrdersSideEnum {
    Buy = "BUY",
    Sell = "SELL",
    Assn = "ASSN",
    Exer = "EXER"
 ...
 * @enum {string}
 */
export declare enum IserverContractConidAlgosParametersValueClassNameEnum {
    Double = "double",
    String = "string",
    Time = "time",
    Boolean = "boolean"
 ...
 * @enum {string}
 */
export declare enum IserverContractConidAlgosParametersEnabledConditionsEnum {
 ...
 * @enum {string}
 */
export declare enum OrderDataExecTypeEnum {
    _1Invalid = "-1 \"Invalid\"",
    _0New = "0 \"New\"",
 ...
 * @enum {string}
 */
export declare enum OrderDataOrderTypeEnum {
    _1Market = "1 \"Market\"",
    _2Limit = "2 \"Limit\"",
    _3Stop = "3 \"Stop\"",
 ...
 * @enum {string}
 */
export declare enum OrderDataOrderStatusEnum {
 ...
 * @enum {string}
 */
export declare enum OrderDataSideEnum {
    _1Buy = "1 \"Buy\"",
    _2Sell = "2 \"Sell\"",
 ...
 * @enum {string}
 */
export declare enum OrderDataSecTypeEnum {
    CsStock = "CS \"Stock\"",
 ...
 * @enum {string}
 */
export declare enum OrderDataTifEnum {
    _0Day = "0 \"Day\"",
    _1Gtc = "1 \"GTC\"",
 ...
 * @enum {string}
 */
export declare enum OrderStatusSideEnum {
    B = "B",
    S = "S",
    X = "X"
}
 ...
 * @enum {string}
 */
export declare enum OrderStatusExitStrategyToolAvailabilityEnum {
    _1 = "1",
    _0 = "0"
}
/**
...
export declare const AccountApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    iserverAccountPnlPartitionedGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountPost: (body: SetAccount, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountsGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdLedgerGet: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdMetaGet: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdSummaryGet: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioAccountsGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioSubaccountsGet: (options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const AccountApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountPnlPartitionedGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20031>>;
    /**
     * If an user has multiple accounts, and user wants to get orders, trades, etc. of an account other than currently selected account, then user can update the currently selected account using this API and then can fetch required information for the newly updated account.
     * @summary Switch Account
     * @param {SetAccount} body account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountPost(body: SetAccount, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20012>>;
    /**
     * Returns a list of accounts the user has trading access to, their respective aliases and the currently selected account. Note this endpoint must be called before modifying an order or querying open orders.
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverAccountsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20011>>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdLedgerGet(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20036>>;
    /**
     * Account information related to account Id /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Information
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdMetaGet(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Account>>>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdSummaryGet(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20035>>;
    /**
     * In non-tiered account structures, returns a list of accounts for which the user can view position and account information. This endpoint must be called prior  to calling other /portfolio endpoints for those accounts. For querying a list of accounts  which the user can trade, see /iserver/accounts. For a list of subaccounts in tiered  account structures (e.g. financial advisor or ibroker accounts) see /portfolio/subaccounts.
     * @summary Portfolio Accounts
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    portfolioAccountsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Account>>>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    portfolioSubaccountsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Account>>;
};
/**
...
export declare const AccountApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountPnlPartitionedGet(options?: any): AxiosPromise<InlineResponse20031>;
    /**
     * If an user has multiple accounts, and user wants to get orders, trades, etc. of an account other than currently selected account, then user can update the currently selected account using this API and then can fetch required information for the newly updated account.
     * @summary Switch Account
     * @param {SetAccount} body account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountPost(body: SetAccount, options?: any): AxiosPromise<InlineResponse20012>;
    /**
     * Returns a list of accounts the user has trading access to, their respective aliases and the currently selected account. Note this endpoint must be called before modifying an order or querying open orders.
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdLedgerGet(accountId: string, options?: any): AxiosPromise<InlineResponse20036>;
    /**
     * Account information related to account Id /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Information
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdSummaryGet(accountId: string, options?: any): AxiosPromise<InlineResponse20035>;
    /**
     * In non-tiered account structures, returns a list of accounts for which the user can view position and account information. This endpoint must be called prior  to calling other /portfolio endpoints for those accounts. For querying a list of accounts  which the user can trade, see /iserver/accounts. For a list of subaccounts in tiered  account structures (e.g. financial advisor or ibroker accounts) see /portfolio/subaccounts.
     * @summary Portfolio Accounts
     * @param {*} [options] Override http request option.
...
export declare class AccountApi extends BaseAPI {
     ...
     * @memberof AccountApi
     */
    iserverAccountPnlPartitionedGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20031>>;
    /**
     * If an user has multiple accounts, and user wants to get orders, trades, etc. of an account other than currently selected account, then user can update the currently selected account using this API and then can fetch required information for the newly updated account.
     * @summary Switch Account
     * @param {SetAccount} body account id
     ...
     * @memberof AccountApi
     */
    iserverAccountPost(body: SetAccount, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20012>>;
    /**
     * Returns a list of accounts the user has trading access to, their respective aliases and the currently selected account. Note this endpoint must be called before modifying an order or querying open orders.
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     ...
     * @memberof AccountApi
     */
    iserverAccountsGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20011>>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @memberof AccountApi
     */
    portfolioAccountIdLedgerGet(accountId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20036>>;
    /**
     * Account information related to account Id /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Information
     * @param {string} accountId account id
     ...
     * @memberof AccountApi
     */
    portfolioAccountIdMetaGet(accountId: string, options?: any): Promise<import("axios").AxiosResponse<Account[]>>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @memberof AccountApi
     */
    portfolioAccountIdSummaryGet(accountId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20035>>;
    /**
     * In non-tiered account structures, returns a list of accounts for which the user can view position and account information. This endpoint must be called prior  to calling other /portfolio endpoints for those accounts. For querying a list of accounts  which the user can trade, see /iserver/accounts. For a list of subaccounts in tiered  account structures (e.g. financial advisor or ibroker accounts) see /portfolio/subaccounts.
     * @summary Portfolio Accounts
     * @param {*} [options] Override http request option.
     ...
     * @memberof AccountApi
     */
    portfolioAccountsGet(options?: any): Promise<import("axios").AxiosResponse<Account[]>>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
     ...
     * @memberof AccountApi
     */
    portfolioSubaccountsGet(options?: any): Promise<import("axios").AxiosResponse<Account>>;
}
/**
 * AlertApi - axios parameter creator
 * @export
 */
export declare const AlertApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertActivatePost: (accountId: string, body: InlineObject3, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertAlertIdDelete: (accountId: string, alertId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertPost: (accountId: string, body: AlertRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertsGet: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAlertIdGet: (id: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountMtaGet: (options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const AlertApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertActivatePost(accountId: string, body: InlineObject3, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20015>>;
    /**
     * Please be careful, if alertId is 0, it will delete all alerts
     * @summary Delete an alert
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertAlertIdDelete(accountId: string, alertId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20015>>;
    /**
     * Please note here, DO NOT pass orderId when creating a new alert, toolId is only required for MTA alert
     * @summary Create or modify alert
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertPost(accountId: string, body: AlertRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20013>>;
    /**
     * The response will contain both active and inactive alerts, but it won\'t have MTA alert
     * @summary Get a list of available alerts
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertsGet(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20014>>>;
    /**
     * Use the endpoint /iserver/account/:accountId/alerts to receive the alert id. The order_id in the response is the alert id.
     * @summary Get details of an alert
     * @param {string} id alert id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAlertIdGet(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AlertResponse>>;
    /**
     * Each login user only has one mobile trading assistant (MTA) alert with it\'s own unique tool id. The tool id cannot be changed. When modified a new order Id is generated. MTA alerts can not be created or deleted. If you call delete /iserver/account/:accountId/alert/:alertId, it will reset MTA to default. See [here](https://www.interactivebrokers.com/en/software/mobileiphonemobile/mobileiphone.htm#monitor/trading-assistant.htm) for more information on MTA alerts.
     * @summary Get MTA alert
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverAccountMtaGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AlertResponse>>;
};
/**
 * AlertApi - factory interface
 * @export
 */
export declare const AlertApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Please note, if alertId is 0, it will activate/deactivate all alerts
     * @summary Activate or deactivate an alert
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertActivatePost(accountId: string, body: InlineObject3, options?: any): AxiosPromise<InlineResponse20015>;
    /**
     * Please be careful, if alertId is 0, it will delete all alerts
     * @summary Delete an alert
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertAlertIdDelete(accountId: string, alertId: string, options?: any): AxiosPromise<InlineResponse20015>;
    /**
     * Please note here, DO NOT pass orderId when creating a new alert, toolId is only required for MTA alert
     * @summary Create or modify alert
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertPost(accountId: string, body: AlertRequest, options?: any): AxiosPromise<InlineResponse20013>;
    /**
     * The response will contain both active and inactive alerts, but it won\'t have MTA alert
     * @summary Get a list of available alerts
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdAlertsGet(accountId: string, options?: any): AxiosPromise<Array<InlineResponse20014>>;
    /**
     * Use the endpoint /iserver/account/:accountId/alerts to receive the alert id. The order_id in the response is the alert id.
     * @summary Get details of an alert
     * @param {string} id alert id
...
export declare class AlertApi extends BaseAPI {
     ...
     * @memberof AlertApi
     */
    iserverAccountAccountIdAlertActivatePost(accountId: string, body: InlineObject3, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20015>>;
    /**
     * Please be careful, if alertId is 0, it will delete all alerts
     * @summary Delete an alert
     * @param {string} accountId account id
     ...
     * @memberof AlertApi
     */
    iserverAccountAccountIdAlertAlertIdDelete(accountId: string, alertId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20015>>;
    /**
     * Please note here, DO NOT pass orderId when creating a new alert, toolId is only required for MTA alert
     * @summary Create or modify alert
     * @param {string} accountId account id
     ...
     * @memberof AlertApi
     */
    iserverAccountAccountIdAlertPost(accountId: string, body: AlertRequest, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20013>>;
    /**
     * The response will contain both active and inactive alerts, but it won\'t have MTA alert
     * @summary Get a list of available alerts
     * @param {string} accountId account id
     ...
     * @memberof AlertApi
     */
    iserverAccountAccountIdAlertsGet(accountId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20014[]>>;
    /**
     * Use the endpoint /iserver/account/:accountId/alerts to receive the alert id. The order_id in the response is the alert id.
     * @summary Get details of an alert
     * @param {string} id alert id
     ...
     * @memberof AlertApi
     */
    iserverAccountAlertIdGet(id: string, options?: any): Promise<import("axios").AxiosResponse<AlertResponse>>;
    /**
     * Each login user only has one mobile trading assistant (MTA) alert with it\'s own unique tool id. The tool id cannot be changed. When modified a new order Id is generated. MTA alerts can not be created or deleted. If you call delete /iserver/account/:accountId/alert/:alertId, it will reset MTA to default. See [here](https://www.interactivebrokers.com/en/software/mobileiphonemobile/mobileiphone.htm#monitor/trading-assistant.htm) for more information on MTA alerts.
     * @summary Get MTA alert
     * @param {*} [options] Override http request option.
     ...
     * @memberof AlertApi
     */
    iserverAccountMtaGet(options?: any): Promise<import("axios").AxiosResponse<AlertResponse>>;
}
/**
 * CCPBetaApi - axios parameter creator
 * @export
 */
export declare const CCPBetaApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    ccpAccountGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpAuthInitPost: (compete?: boolean, locale?: string, mac?: string, machineId?: string, username?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpAuthResponsePost: (auth?: InlineObject2, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpOrderDelete: (acct: string, id: number, options?: any) => Promise<RequestArgs>;
    /**
     * Submits an Order.
     ...
     * @throws {RequiredError}
     */
    ccpOrderPost: (acct: string, conid: number, ccy: "USD" | "GBP" | "EUR", exchange: "NYSE" | "CBOE" | "NYMEX", qty: number, type?: "limit" | "market", side?: "sell" | "buy", price?: number, tif?: "IOC" | "GTC", options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpOrderPut: (acct: string, id: number, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpOrdersGet: (acct: string, cancelled?: boolean, options?: any) => Promise<RequestArgs>;
    /**
     * List of positions
     * @summary Positions
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ccpPositionsGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpStatusGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ccpTradesGet: (from?: string, to?: string, options?: any) => Promise<RequestArgs>;
};
/**
 * CCPBetaApi - functional programming interface
 * @export
 */
export declare const CCPBetaApiFp: (configuration?: Configuration) => {
    /**
     * Provides the list of tradeable accounts
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ccpAccountGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2009>>;
    /**
     * Initiate a brokerage session to CCP. Only one brokerage session type can run at a time. If an existing brokerage session to iServer is running then call the endpoint /logout first. Note at this time only order management is possible from CCP session, market data and scanner endpoints can\'t be used since they are only available from iServer session. Work is in progress to provide new CCP endpoints for market data and scanners.
     * @summary Start CCP Session
     * @param {boolean} [compete] Allow competing CCP session to run
     ...
     * @throws {RequiredError}
     */
    ccpAuthInitPost(compete?: boolean, locale?: string, mac?: string, machineId?: string, username?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>>;
    /**
     * Session Token Authentication
     * @summary Complete CCP Session
     * @param {InlineObject2} [auth]
     ...
     * @throws {RequiredError}
     */
    ccpAuthResponsePost(auth?: InlineObject2, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2007>>;
    /**
     * Sends an Order cancellation request. The status of the order can be queried through /ccp/order. Passing arguments as GET is also supported (requires passing action=delete) (GET is meant for development only)
     * @summary Delete Order
     * @param {string} acct Account Number
     ...
     * @throws {RequiredError}
     */
    ccpOrderDelete(acct: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderData>>;
    /**
     * Submits an Order.
     * @summary Submit Order
     * @param {string} acct User Account
     ...
     * @throws {RequiredError}
     */
    ccpOrderPost(acct: string, conid: number, ccy: "USD" | "GBP" | "EUR", exchange: "NYSE" | "CBOE" | "NYMEX", qty: number, type?: "limit" | "market", side?: "sell" | "buy", price?: number, tif?: "IOC" | "GTC", options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderData>>;
    /**
     * Updates an Order. Updating an order requires the same arguments as placing an order besides the conid. Note: The status of the order can be queried through GET /ccp/order.
     * @summary Update Order
     * @param {string} acct User Account
     ...
     * @throws {RequiredError}
     */
    ccpOrderPut(acct: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderData>>;
    /**
     * Get status for all orders
     * @summary Order Status
     * @param {string} acct User Account
     ...
     * @throws {RequiredError}
     */
    ccpOrdersGet(acct: string, cancelled?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010>>;
    /**
     * List of positions
     * @summary Positions
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ccpPositionsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PositionData>>;
    /**
     * Provide the current CCP session status. When using the Gateway this endpoint will also initiate a brokerage session to CCP by sending /auth/init and response.
     * @summary CCP Status
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ccpStatusGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2008>>;
    /**
     * Get a list of Trades, by default, the list is from today midnight to Date.now().
     * @summary Trades
     * @param {string} [from] From Date (YYYYMMDD-HH:mm:ss) or offset (-1,-2,-3..)
     ...
     * @throws {RequiredError}
     */
    ccpTradesGet(from?: string, to?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010>>;
};
/**
 * CCPBetaApi - factory interface
 * @export
 */
export declare const CCPBetaApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Provides the list of tradeable accounts
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    ccpAuthInitPost(compete?: boolean, locale?: string, mac?: string, machineId?: string, username?: string, options?: any): AxiosPromise<InlineResponse2001>;
    /**
     * Session Token Authentication
     * @summary Complete CCP Session
     * @param {InlineObject2} [auth]
     ...
     * @throws {RequiredError}
     */
    ccpAuthResponsePost(auth?: InlineObject2, options?: any): AxiosPromise<InlineResponse2007>;
    /**
     * Sends an Order cancellation request. The status of the order can be queried through /ccp/order. Passing arguments as GET is also supported (requires passing action=delete) (GET is meant for development only)
     * @summary Delete Order
     * @param {string} acct Account Number
     ...
     * @throws {RequiredError}
     */
    ccpOrdersGet(acct: string, cancelled?: boolean, options?: any): AxiosPromise<InlineResponse20010>;
    /**
     * List of positions
     * @summary Positions
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    ccpTradesGet(from?: string, to?: string, options?: any): AxiosPromise<InlineResponse20010>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class CCPBetaApi extends BaseAPI {
    /**
     * Provides the list of tradeable accounts
     * @summary Brokerage Accounts
     * @param {*} [options] Override http request option.
     ...
     * @memberof CCPBetaApi
     */
    ccpAccountGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse2009>>;
    /**
     * Initiate a brokerage session to CCP. Only one brokerage session type can run at a time. If an existing brokerage session to iServer is running then call the endpoint /logout first. Note at this time only order management is possible from CCP session, market data and scanner endpoints can\'t be used since they are only available from iServer session. Work is in progress to provide new CCP endpoints for market data and scanners.
     * @summary Start CCP Session
     * @param {boolean} [compete] Allow competing CCP session to run
     ...
     * @memberof CCPBetaApi
     */
    ccpAuthInitPost(compete?: boolean, locale?: string, mac?: string, machineId?: string, username?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2001>>;
    /**
     * Session Token Authentication
     * @summary Complete CCP Session
     * @param {InlineObject2} [auth]
     ...
     * @memberof CCPBetaApi
     */
    ccpAuthResponsePost(auth?: InlineObject2, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2007>>;
    /**
     * Sends an Order cancellation request. The status of the order can be queried through /ccp/order. Passing arguments as GET is also supported (requires passing action=delete) (GET is meant for development only)
     * @summary Delete Order
     * @param {string} acct Account Number
     ...
     * @memberof CCPBetaApi
     */
    ccpOrderDelete(acct: string, id: number, options?: any): Promise<import("axios").AxiosResponse<OrderData>>;
    /**
     * Submits an Order.
     * @summary Submit Order
     * @param {string} acct User Account
     ...
     * @memberof CCPBetaApi
     */
    ccpOrderPost(acct: string, conid: number, ccy: "USD" | "GBP" | "EUR", exchange: "NYSE" | "CBOE" | "NYMEX", qty: number, type?: "limit" | "market", side?: "sell" | "buy", price?: number, tif?: "IOC" | "GTC", options?: any): Promise<import("axios").AxiosResponse<OrderData>>;
    /**
     * Updates an Order. Updating an order requires the same arguments as placing an order besides the conid. Note: The status of the order can be queried through GET /ccp/order.
     * @summary Update Order
     * @param {string} acct User Account
     ...
     * @memberof CCPBetaApi
     */
    ccpOrderPut(acct: string, id: number, options?: any): Promise<import("axios").AxiosResponse<OrderData>>;
    /**
     * Get status for all orders
     * @summary Order Status
     * @param {string} acct User Account
     ...
     * @memberof CCPBetaApi
     */
    ccpOrdersGet(acct: string, cancelled?: boolean, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20010>>;
    /**
     * List of positions
     * @summary Positions
     * @param {*} [options] Override http request option.
     ...
     * @memberof CCPBetaApi
     */
    ccpPositionsGet(options?: any): Promise<import("axios").AxiosResponse<PositionData>>;
    /**
     * Provide the current CCP session status. When using the Gateway this endpoint will also initiate a brokerage session to CCP by sending /auth/init and response.
     * @summary CCP Status
     * @param {*} [options] Override http request option.
     ...
     * @memberof CCPBetaApi
     */
    ccpStatusGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse2008>>;
    /**
     * Get a list of Trades, by default, the list is from today midnight to Date.now().
     * @summary Trades
     * @param {string} [from] From Date (YYYYMMDD-HH:mm:ss) or offset (-1,-2,-3..)
     ...
     * @memberof CCPBetaApi
     */
    ccpTradesGet(from?: string, to?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20010>>;
}
/**
 * ContractApi - axios parameter creator
 * @export
 */
export declare const ContractApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    iserverContractConidAlgosGet: (conid: string, algos?: string, addDescription?: string, addParams?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverContractConidInfoAndRulesGet: (conid: string, isBuy: boolean, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverContractConidInfoGet: (conid: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverSecdefInfoGet: (conid: string, sectype: string, month?: string, exchange?: string, strike?: string, right?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverSecdefSearchPost: (symbol: InlineObject8, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverSecdefStrikesGet: (conid: string, sectype: string, month: string, exchange?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    trsrvFuturesGet: (symbols: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefPost: (body: InlineObject9, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefScheduleGet: (assetClass: string, symbol: string, exchange?: string, exchangeFilter?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    trsrvStocksGet: (symbols: string, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ContractApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverContractConidAlgosGet(conid: string, algos?: string, addDescription?: string, addParams?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20027>>>;
    /**
     * Returns trading related rules and info for contract
     * @summary Info and Rules
     * @param {string} conid IBKR contract identifier
     ...
     * @throws {RequiredError}
     */
    iserverContractConidInfoAndRulesGet(conid: string, isBuy: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20028>>;
    /**
     * Using the Contract Identifier get contract info. You can use this to prefill your order before you submit an order
     * @summary Contract Details
     * @param {string} conid contract id
     ...
     * @throws {RequiredError}
     */
    iserverContractConidInfoGet(conid: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Contract>>;
    /**
     * Provides Contract Details of Futures, Options, Warrants, Cash and CFDs based on conid. To get the strike price for Options/Warrants use \"/iserver/secdef/strikes\" endpoint. Must call /secdef/search for the underlying contract first.
     * @summary Secdef Info
     * @param {string} conid underlying contract id
     ...
     * @throws {RequiredError}
     */
    iserverSecdefInfoGet(conid: string, sectype: string, month?: string, exchange?: string, strike?: string, right?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Search by underlying symbol or company name. Relays back what derivative contract(s) it has. This endpoint must be called before using /secdef/info. If company name is specified will only receive limited response: conid, companyName, companyHeader and symbol.
     * @summary Search by Symbol or Name
     * @param {InlineObject8} symbol
     ...
     * @throws {RequiredError}
     */
    iserverSecdefSearchPost(symbol: InlineObject8, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20025>>>;
    /**
     * Query strikes for Options/Warrants. For the conid of the underlying contract, available contract months and exchanges use \"/iserver/secdef/search\"
     * @summary Search Strikes
     * @param {string} conid contract id of the underlying contract
     ...
     * @throws {RequiredError}
     */
    iserverSecdefStrikesGet(conid: string, sectype: string, month: string, exchange?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20026>>;
    /**
     * Returns a list of non-expired future contracts for given symbol(s)
     * @summary Security Futures by Symbol
     * @param {string} symbols list of case-sensitive symbols separated by comma
     ...
     * @throws {RequiredError}
     */
    trsrvFuturesGet(symbols: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20033>>;
    /**
     * Returns a list of security definitions for the given conids
     * @summary Secdef by Conid
     * @param {InlineObject9} body
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefPost(body: InlineObject9, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     * Returns the trading schedule up to a month for the requested contract
     * @summary Get trading schedule for symbol
     * @param {string} assetClass specify the asset class of the contract. Available values-- Stock: STK, Option: OPT, Future: FUT, Contract For Difference: CFD, Warrant: WAR, Forex: SWP, Mutual Fund: FND, Bond: BND, Inter-Commodity Spreads: ICS
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefScheduleGet(assetClass: string, symbol: string, exchange?: string, exchangeFilter?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20032>>;
    /**
     * Returns an object contains all stock contracts for given symbol(s)
     * @summary Security Stocks by Symbol
     * @param {string} symbols list of upper-sensitive symbols separated by comma
     ...
     * @throws {RequiredError}
     */
    trsrvStocksGet(symbols: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20034>>;
};
/**
 * ContractApi - factory interface
 * @export
 */
export declare const ContractApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns supported IB Algos for contract. Must be called a second time to query the list of available parameters.
     * @summary IB Algo Params
     * @param {string} conid IBKR contract identifier
     ...
     * @throws {RequiredError}
     */
    iserverContractConidAlgosGet(conid: string, algos?: string, addDescription?: string, addParams?: string, options?: any): AxiosPromise<Array<InlineResponse20027>>;
    /**
     * Returns trading related rules and info for contract
     * @summary Info and Rules
     * @param {string} conid IBKR contract identifier
     ...
     * @throws {RequiredError}
     */
    iserverContractConidInfoAndRulesGet(conid: string, isBuy: boolean, options?: any): AxiosPromise<InlineResponse20028>;
    /**
     * Using the Contract Identifier get contract info. You can use this to prefill your order before you submit an order
     * @summary Contract Details
     * @param {string} conid contract id
     ...
     * @throws {RequiredError}
     */
    iserverSecdefInfoGet(conid: string, sectype: string, month?: string, exchange?: string, strike?: string, right?: string, options?: any): AxiosPromise<object>;
    /**
     * Search by underlying symbol or company name. Relays back what derivative contract(s) it has. This endpoint must be called before using /secdef/info. If company name is specified will only receive limited response: conid, companyName, companyHeader and symbol.
     * @summary Search by Symbol or Name
     * @param {InlineObject8} symbol
     ...
     * @throws {RequiredError}
     */
    iserverSecdefSearchPost(symbol: InlineObject8, options?: any): AxiosPromise<Array<InlineResponse20025>>;
    /**
     * Query strikes for Options/Warrants. For the conid of the underlying contract, available contract months and exchanges use \"/iserver/secdef/search\"
     * @summary Search Strikes
     * @param {string} conid contract id of the underlying contract
     ...
     * @throws {RequiredError}
     */
    iserverSecdefStrikesGet(conid: string, sectype: string, month: string, exchange?: string, options?: any): AxiosPromise<InlineResponse20026>;
    /**
     * Returns a list of non-expired future contracts for given symbol(s)
     * @summary Security Futures by Symbol
     * @param {string} symbols list of case-sensitive symbols separated by comma
     ...
     * @throws {RequiredError}
     */
    trsrvFuturesGet(symbols: string, options?: any): AxiosPromise<InlineResponse20033>;
    /**
     * Returns a list of security definitions for the given conids
     * @summary Secdef by Conid
     * @param {InlineObject9} body
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefPost(body: InlineObject9, options?: any): AxiosPromise<Array<object>>;
    /**
     * Returns the trading schedule up to a month for the requested contract
     * @summary Get trading schedule for symbol
     * @param {string} assetClass specify the asset class of the contract. Available values-- Stock: STK, Option: OPT, Future: FUT, Contract For Difference: CFD, Warrant: WAR, Forex: SWP, Mutual Fund: FND, Bond: BND, Inter-Commodity Spreads: ICS
     ...
     * @throws {RequiredError}
     */
    trsrvSecdefScheduleGet(assetClass: string, symbol: string, exchange?: string, exchangeFilter?: string, options?: any): AxiosPromise<InlineResponse20032>;
    /**
     * Returns an object contains all stock contracts for given symbol(s)
     * @summary Security Stocks by Symbol
     * @param {string} symbols list of upper-sensitive symbols separated by comma
     ...
     * @throws {RequiredError}
     */
    trsrvStocksGet(symbols: string, options?: any): AxiosPromise<InlineResponse20034>;
};
/**
...
export declare class ContractApi extends BaseAPI {
     ...
     */
    iserverContractConidAlgosGet(conid: string, algos?: string, addDescription?: string, addParams?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20027[]>>;
    /**
     * Returns trading related rules and info for contract
     * @summary Info and Rules
     * @param {string} conid IBKR contract identifier
     ...
     * @memberof ContractApi
     */
    iserverContractConidInfoAndRulesGet(conid: string, isBuy: boolean, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20028>>;
    /**
     * Using the Contract Identifier get contract info. You can use this to prefill your order before you submit an order
     * @summary Contract Details
     * @param {string} conid contract id
     ...
     * @memberof ContractApi
     */
    iserverContractConidInfoGet(conid: string, options?: any): Promise<import("axios").AxiosResponse<Contract>>;
    /**
     * Provides Contract Details of Futures, Options, Warrants, Cash and CFDs based on conid. To get the strike price for Options/Warrants use \"/iserver/secdef/strikes\" endpoint. Must call /secdef/search for the underlying contract first.
     * @summary Secdef Info
     * @param {string} conid underlying contract id
     ...
     * @memberof ContractApi
     */
    iserverSecdefInfoGet(conid: string, sectype: string, month?: string, exchange?: string, strike?: string, right?: string, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Search by underlying symbol or company name. Relays back what derivative contract(s) it has. This endpoint must be called before using /secdef/info. If company name is specified will only receive limited response: conid, companyName, companyHeader and symbol.
     * @summary Search by Symbol or Name
     * @param {InlineObject8} symbol
     ...
     * @memberof ContractApi
     */
    iserverSecdefSearchPost(symbol: InlineObject8, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20025[]>>;
    /**
     * Query strikes for Options/Warrants. For the conid of the underlying contract, available contract months and exchanges use \"/iserver/secdef/search\"
     * @summary Search Strikes
     * @param {string} conid contract id of the underlying contract
     ...
     * @memberof ContractApi
     */
    iserverSecdefStrikesGet(conid: string, sectype: string, month: string, exchange?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20026>>;
    /**
     * Returns a list of non-expired future contracts for given symbol(s)
     * @summary Security Futures by Symbol
     * @param {string} symbols list of case-sensitive symbols separated by comma
     ...
     * @memberof ContractApi
     */
    trsrvFuturesGet(symbols: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20033>>;
    /**
     * Returns a list of security definitions for the given conids
     * @summary Secdef by Conid
     * @param {InlineObject9} body
     ...
     * @memberof ContractApi
     */
    trsrvSecdefPost(body: InlineObject9, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     * Returns the trading schedule up to a month for the requested contract
     * @summary Get trading schedule for symbol
     * @param {string} assetClass specify the asset class of the contract. Available values-- Stock: STK, Option: OPT, Future: FUT, Contract For Difference: CFD, Warrant: WAR, Forex: SWP, Mutual Fund: FND, Bond: BND, Inter-Commodity Spreads: ICS
     ...
     * @memberof ContractApi
     */
    trsrvSecdefScheduleGet(assetClass: string, symbol: string, exchange?: string, exchangeFilter?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20032>>;
    /**
     * Returns an object contains all stock contracts for given symbol(s)
     * @summary Security Stocks by Symbol
     * @param {string} symbols list of upper-sensitive symbols separated by comma
     ...
     * @memberof ContractApi
     */
    trsrvStocksGet(symbols: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20034>>;
}
/**
 * FYIApi - axios parameter creator
 * @export
 */
export declare const FYIApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsDeviceIdDelete: (deviceId: string, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsDevicePost: (body: InlineObject1, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsEmailPut: (enabled: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsGet: (options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodeGet: (typecode: string, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodePut: (typecode: string, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsGet: (max: string, exclude?: string, include?: string, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsMoreGet: (id: string, options?: any) => Promise<RequestArgs>;
    /**
     *
     * @summary Get a list of notifications
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsNotificationIdPut: (notificationId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    fyiSettingsGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    fyiSettingsTypecodePost: (typecode: string, body: InlineObject, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    fyiUnreadnumberGet: (options?: any) => Promise<RequestArgs>;
};
/**
 * FYIApi - functional programming interface
 * @export
 */
export declare const FYIApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Delete a device
     * @param {string} deviceId device ID
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsDeviceIdDelete(deviceId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     *
     * @summary Enable/Disable device option
     * @param {InlineObject1} body
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsDevicePost(body: InlineObject1, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>>;
    /**
     *
     * @summary Enable/Disable email option
     * @param {string} enabled true/false
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsEmailPut(enabled: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>>;
    /**
     * options for sending fyis to email and other devices
     * @summary Get delivery options
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2006>>;
    /**
     *
     * @summary Get disclaimer for a certain kind of fyi
     * @param {string} typecode fyi code, for example --M8, EA
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodeGet(typecode: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>>;
    /**
     *
     * @summary Mark disclaimer read
     * @param {string} typecode fyi code, for example --M8, EA
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodePut(typecode: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} max max number of fyis in response
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsGet(max: string, exclude?: string, include?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     *
     * @summary Get more notifications based on a certain one
     * @param {string} id id of last notification in the list
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsMoreGet(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} notificationId mark a notification read
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsNotificationIdPut(notificationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Return the current choices of subscriptions, we can toggle the option
     * @summary Get a list of subscriptions
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    fyiSettingsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse2003>>>;
    /**
     * Configure which typecode you would like to enable/disable.
     * @summary Enable/Disable certain subscription
     * @param {string} typecode fyi code
     ...
     * @throws {RequiredError}
     */
    fyiSettingsTypecodePost(typecode: string, body: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Returns the total number of unread fyis
     * @summary Get unread number of fyis. The HTTP method POST is also supported.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    fyiUnreadnumberGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>>;
};
/**
 * FYIApi - factory interface
 * @export
 */
export declare const FYIApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Delete a device
     * @param {string} deviceId device ID
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsDevicePost(body: InlineObject1, options?: any): AxiosPromise<InlineResponse2005>;
    /**
     *
     * @summary Enable/Disable email option
     * @param {string} enabled true/false
     ...
     * @throws {RequiredError}
     */
    fyiDeliveryoptionsEmailPut(enabled: string, options?: any): AxiosPromise<InlineResponse2005>;
    /**
     * options for sending fyis to email and other devices
     * @summary Get delivery options
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodeGet(typecode: string, options?: any): AxiosPromise<InlineResponse2004>;
    /**
     *
     * @summary Mark disclaimer read
     * @param {string} typecode fyi code, for example --M8, EA
     ...
     * @throws {RequiredError}
     */
    fyiDisclaimerTypecodePut(typecode: string, options?: any): AxiosPromise<InlineResponse2005>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} max max number of fyis in response
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsGet(max: string, exclude?: string, include?: string, options?: any): AxiosPromise<Array<object>>;
    /**
     *
     * @summary Get more notifications based on a certain one
     * @param {string} id id of last notification in the list
     ...
     * @throws {RequiredError}
     */
    fyiNotificationsMoreGet(id: string, options?: any): AxiosPromise<Array<object>>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} notificationId mark a notification read
     ...
     * @throws {RequiredError}
     */
    fyiSettingsTypecodePost(typecode: string, body: InlineObject, options?: any): AxiosPromise<object>;
    /**
     * Returns the total number of unread fyis
     * @summary Get unread number of fyis. The HTTP method POST is also supported.
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class FYIApi extends BaseAPI {
    /**
     *
     * @summary Delete a device
     * @param {string} deviceId device ID
     ...
     * @memberof FYIApi
     */
    fyiDeliveryoptionsDeviceIdDelete(deviceId: string, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     *
     * @summary Enable/Disable device option
     * @param {InlineObject1} body
     ...
     * @memberof FYIApi
     */
    fyiDeliveryoptionsDevicePost(body: InlineObject1, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2005>>;
    /**
     *
     * @summary Enable/Disable email option
     * @param {string} enabled true/false
     ...
     * @memberof FYIApi
     */
    fyiDeliveryoptionsEmailPut(enabled: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2005>>;
    /**
     * options for sending fyis to email and other devices
     * @summary Get delivery options
     * @param {*} [options] Override http request option.
     ...
     * @memberof FYIApi
     */
    fyiDeliveryoptionsGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse2006>>;
    /**
     *
     * @summary Get disclaimer for a certain kind of fyi
     * @param {string} typecode fyi code, for example --M8, EA
     ...
     * @memberof FYIApi
     */
    fyiDisclaimerTypecodeGet(typecode: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2004>>;
    /**
     *
     * @summary Mark disclaimer read
     * @param {string} typecode fyi code, for example --M8, EA
     ...
     * @memberof FYIApi
     */
    fyiDisclaimerTypecodePut(typecode: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2005>>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} max max number of fyis in response
     ...
     * @memberof FYIApi
     */
    fyiNotificationsGet(max: string, exclude?: string, include?: string, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     *
     * @summary Get more notifications based on a certain one
     * @param {string} id id of last notification in the list
     ...
     * @memberof FYIApi
     */
    fyiNotificationsMoreGet(id: string, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     *
     * @summary Get a list of notifications
     * @param {string} notificationId mark a notification read
     ...
     * @memberof FYIApi
     */
    fyiNotificationsNotificationIdPut(notificationId: string, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Return the current choices of subscriptions, we can toggle the option
     * @summary Get a list of subscriptions
     * @param {*} [options] Override http request option.
     ...
     * @memberof FYIApi
     */
    fyiSettingsGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse2003[]>>;
    /**
     * Configure which typecode you would like to enable/disable.
     * @summary Enable/Disable certain subscription
     * @param {string} typecode fyi code
     ...
     * @memberof FYIApi
     */
    fyiSettingsTypecodePost(typecode: string, body: InlineObject, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Returns the total number of unread fyis
     * @summary Get unread number of fyis. The HTTP method POST is also supported.
     * @param {*} [options] Override http request option.
     ...
     * @memberof FYIApi
     */
    fyiUnreadnumberGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse2002>>;
}
/**
 * IBCustApi - axios parameter creator
 * @export
 */
export declare const IBCustApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    ibcustEntityInfoGet: (options?: any) => Promise<RequestArgs>;
};
/**
 * IBCustApi - functional programming interface
 * @export
 */
export declare const IBCustApiFp: (configuration?: Configuration) => {
    /**
     * Returns Applicant Id with all owner related entities
     * @summary IBCust Entity Info
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ibcustEntityInfoGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20039>>>;
};
/**
 * IBCustApi - factory interface
 * @export
 */
export declare const IBCustApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns Applicant Id with all owner related entities
     * @summary IBCust Entity Info
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ibcustEntityInfoGet(options?: any): AxiosPromise<Array<InlineResponse20039>>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class IBCustApi extends BaseAPI {
    /**
     * Returns Applicant Id with all owner related entities
     * @summary IBCust Entity Info
     * @param {*} [options] Override http request option.
     ...
     * @memberof IBCustApi
     */
    ibcustEntityInfoGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20039[]>>;
}
/**
...
export declare const MarketDataApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataConidUnsubscribeGet: (conid: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataHistoryGet: (conid: string, period: string, exchange?: string, bar?: string, outsideRth?: boolean, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataSnapshotGet: (conids: string, since?: number, fields?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataUnsubscribeallGet: (options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const MarketDataApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataConidUnsubscribeGet(conid: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20023>>;
    /**
     * Get historical market Data for given conid, length of data is controlled by \'period\' and \'bar\'. Formatted as: min=minute, h=hour, d=day, w=week, m=month, y=year e.g. period =1y with bar =1w returns 52 data points (Max of 1000 data points supported). **Note**: There\'s a limit of 5 concurrent requests. Excessive requests will return a \'Too many requests\' status 429 response.
     * @summary Market Data History
     * @param {string} conid contract id
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataHistoryGet(conid: string, period: string, exchange?: string, bar?: string, outsideRth?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HistoryData>>;
    /**
     * Get Market Data for the given conid(s). The endpoint will return by default bid, ask, last, change, change pct, close, listing exchange. See response fields for a list of available fields that can be request via fields argument. The endpoint /iserver/accounts must be called prior to /iserver/marketdata/snapshot. For derivative contracts the endpoint /iserver/secdef/search must be called first. First /snapshot endpoint call for given conid will initiate the market data request.  To receive all available fields the /snapshot endpoint will need to be called several times. To receive streaming market data the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Market Data
     * @param {string} conids list of conids separated by comma
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataSnapshotGet(conids: string, since?: number, fields?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20022>>>;
    /**
     * Cancel all market data request(s). To cancel market data for given conid, see /iserver/marketdata/{conid}/unsubscribe.
     * @summary Market Data Cancel (All)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverMarketdataUnsubscribeallGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20024>>;
};
/**
...
export declare const MarketDataApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataConidUnsubscribeGet(conid: string, options?: any): AxiosPromise<InlineResponse20023>;
    /**
     * Get historical market Data for given conid, length of data is controlled by \'period\' and \'bar\'. Formatted as: min=minute, h=hour, d=day, w=week, m=month, y=year e.g. period =1y with bar =1w returns 52 data points (Max of 1000 data points supported). **Note**: There\'s a limit of 5 concurrent requests. Excessive requests will return a \'Too many requests\' status 429 response.
     * @summary Market Data History
     * @param {string} conid contract id
     ...
     * @throws {RequiredError}
     */
    iserverMarketdataSnapshotGet(conids: string, since?: number, fields?: string, options?: any): AxiosPromise<Array<InlineResponse20022>>;
    /**
     * Cancel all market data request(s). To cancel market data for given conid, see /iserver/marketdata/{conid}/unsubscribe.
     * @summary Market Data Cancel (All)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverMarketdataUnsubscribeallGet(options?: any): AxiosPromise<InlineResponse20024>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class MarketDataApi extends BaseAPI {
    /**
     * Cancel market data for given conid. To cancel all market data request(s), see /iserver/marketdata/unsubscribeall.
     * @summary Market Data Cancel (Single)
     * @param {string} conid contract id
     ...
     */
    iserverMarketdataConidUnsubscribeGet(conid: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20023>>;
    /**
     * Get historical market Data for given conid, length of data is controlled by \'period\' and \'bar\'. Formatted as: min=minute, h=hour, d=day, w=week, m=month, y=year e.g. period =1y with bar =1w returns 52 data points (Max of 1000 data points supported). **Note**: There\'s a limit of 5 concurrent requests. Excessive requests will return a \'Too many requests\' status 429 response.
     * @summary Market Data History
     * @param {string} conid contract id
     ...
     * @memberof MarketDataApi
     */
    iserverMarketdataHistoryGet(conid: string, period: string, exchange?: string, bar?: string, outsideRth?: boolean, options?: any): Promise<import("axios").AxiosResponse<HistoryData>>;
    /**
     * Get Market Data for the given conid(s). The endpoint will return by default bid, ask, last, change, change pct, close, listing exchange. See response fields for a list of available fields that can be request via fields argument. The endpoint /iserver/accounts must be called prior to /iserver/marketdata/snapshot. For derivative contracts the endpoint /iserver/secdef/search must be called first. First /snapshot endpoint call for given conid will initiate the market data request.  To receive all available fields the /snapshot endpoint will need to be called several times. To receive streaming market data the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Market Data
     * @param {string} conids list of conids separated by comma
     ...
     * @memberof MarketDataApi
     */
    iserverMarketdataSnapshotGet(conids: string, since?: number, fields?: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20022[]>>;
    /**
     * Cancel all market data request(s). To cancel market data for given conid, see /iserver/marketdata/{conid}/unsubscribe.
     * @summary Market Data Cancel (All)
     * @param {*} [options] Override http request option.
     ...
     * @memberof MarketDataApi
     */
    iserverMarketdataUnsubscribeallGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20024>>;
}
/**
...
export declare const OrderApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdDelete: (accountId: string, orderId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdPost: (accountId: string, orderId: string, body: ModifyOrder, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderPost: (accountId: string, body: OrderRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderWhatifPost: (accountId: string, body: OrderRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersPost: (accountId: string, body: InlineObject5, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersWhatifPost: (accountId: string, body: InlineObject7, options?: any) => Promise<RequestArgs>;
    /**
     *
     * @summary Order Status
     * @param {string} orderId Customer order id, use /iservers/account/orders endpoint to query orderId.
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrderStatusOrderIdGet: (orderId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersFaGroupPost: (faGroup: string, body: OrderRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersGet: (body?: InlineObject4, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverReplyReplyidPost: (replyid: string, body: InlineObject6, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const OrderApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdDelete(accountId: string, orderId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20021>>;
    /**
     * Modifies an open order. Must call /iserver/accounts endpoint prior to modifying an order. Use /iservers/account/orders endpoint to review open-order(s).
     * @summary Modify Order
     * @param {string} accountId account id, or fa group if modifying a group order
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdPost(accountId: string, orderId: string, body: ModifyOrder, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20020>>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders, just pass one order in the array, the order structure will be same. Please note here, sometimes this endpoint alone can\'t make sure you submit the order successfully, you could receive some questions in the response, you have to to answer them in order to submit the order successfully. You can use \"/iserver/reply/{replyid}\" endpoint to answer questions
     * @summary Place Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderPost(accountId: string, body: OrderRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20017>>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders/whatif, just pass one order in the array, the order structure will be same. This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response.
     * @summary Preview Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderWhatifPost(accountId: string, body: OrderRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20019>>;
    /**
     * You can pass a list of orders here such as bracket and OCA orders. Notes for OCA(one cancel all orders) orders: 1. if one order in the group is filled/cancelled, all the others in the same group will be cancelled. 2. To create OCA orders, please set isSingleGroup to true in each order 3. All orders in the same group will have same oca_group_id, you can get oca_group_id from /iserver/account/order/status/{orderId} end-point after orders are placed successfully
     * @summary Place Orders
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersPost(accountId: string, body: InlineObject5, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20017>>>;
    /**
     * This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response. Also supports bracket orders.
     * @summary Preview Orders
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersWhatifPost(accountId: string, body: InlineObject7, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20019>>;
    /**
     *
     * @summary Order Status
     * @param {string} orderId Customer order id, use /iservers/account/orders endpoint to query orderId.
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrderStatusOrderIdGet(orderId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderStatus>>;
    /**
     * Financial Advisors can use this endpoint to place an order for a specified group. To place an order for a specified account use the endpoint /iserver/account/{accountId}/order. More information about groups can be found in the [TWS Users\' Guide:](https://guides.interactivebrokers.com/twsguide/twsguide.htm#usersguidebook/financialadvisors/create_an_account_group_for_share_allocation.htm).
     * @summary Place Orders for FA
     * @param {string} faGroup financial advisor group
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersFaGroupPost(faGroup: string, body: OrderRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20017>>>;
    /**
     * The endpoint is meant to be used in polling mode, e.g. requesting every x seconds. The response will contain two objects, one is notification, the other is orders. Orders is the list of live orders (cancelled, filled, submitted). Notifications contains information about execute orders as they happen, see status field. To receive streaming live orders the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Live Orders
     * @param {InlineObject4} [body]
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersGet(body?: InlineObject4, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20016>>;
    /**
     * Reply to questions when placing orders and submit orders
     * @summary Place Order Reply
     * @param {string} replyid Please use the \&quot;id\&quot; from the response of \&quot;Place Order\&quot; endpoint
     ...
     * @throws {RequiredError}
     */
    iserverReplyReplyidPost(replyid: string, body: InlineObject6, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20018>>>;
};
/**
...
export declare const OrderApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdDelete(accountId: string, orderId: string, options?: any): AxiosPromise<InlineResponse20021>;
    /**
     * Modifies an open order. Must call /iserver/accounts endpoint prior to modifying an order. Use /iservers/account/orders endpoint to review open-order(s).
     * @summary Modify Order
     * @param {string} accountId account id, or fa group if modifying a group order
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderOrderIdPost(accountId: string, orderId: string, body: ModifyOrder, options?: any): AxiosPromise<Array<InlineResponse20020>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders, just pass one order in the array, the order structure will be same. Please note here, sometimes this endpoint alone can\'t make sure you submit the order successfully, you could receive some questions in the response, you have to to answer them in order to submit the order successfully. You can use \"/iserver/reply/{replyid}\" endpoint to answer questions
     * @summary Place Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderPost(accountId: string, body: OrderRequest, options?: any): AxiosPromise<Array<InlineResponse20017>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders/whatif, just pass one order in the array, the order structure will be same. This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response.
     * @summary Preview Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrderWhatifPost(accountId: string, body: OrderRequest, options?: any): AxiosPromise<InlineResponse20019>;
    /**
     * You can pass a list of orders here such as bracket and OCA orders. Notes for OCA(one cancel all orders) orders: 1. if one order in the group is filled/cancelled, all the others in the same group will be cancelled. 2. To create OCA orders, please set isSingleGroup to true in each order 3. All orders in the same group will have same oca_group_id, you can get oca_group_id from /iserver/account/order/status/{orderId} end-point after orders are placed successfully
     * @summary Place Orders
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersPost(accountId: string, body: InlineObject5, options?: any): AxiosPromise<Array<InlineResponse20017>>;
    /**
     * This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response. Also supports bracket orders.
     * @summary Preview Orders
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    iserverAccountAccountIdOrdersWhatifPost(accountId: string, body: InlineObject7, options?: any): AxiosPromise<InlineResponse20019>;
    /**
     *
     * @summary Order Status
     * @param {string} orderId Customer order id, use /iservers/account/orders endpoint to query orderId.
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersFaGroupPost(faGroup: string, body: OrderRequest, options?: any): AxiosPromise<Array<InlineResponse20017>>;
    /**
     * The endpoint is meant to be used in polling mode, e.g. requesting every x seconds. The response will contain two objects, one is notification, the other is orders. Orders is the list of live orders (cancelled, filled, submitted). Notifications contains information about execute orders as they happen, see status field. To receive streaming live orders the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Live Orders
     * @param {InlineObject4} [body]
     ...
     * @throws {RequiredError}
     */
    iserverAccountOrdersGet(body?: InlineObject4, options?: any): AxiosPromise<InlineResponse20016>;
    /**
     * Reply to questions when placing orders and submit orders
     * @summary Place Order Reply
     * @param {string} replyid Please use the \&quot;id\&quot; from the response of \&quot;Place Order\&quot; endpoint
     ...
     * @throws {RequiredError}
     */
    iserverReplyReplyidPost(replyid: string, body: InlineObject6, options?: any): AxiosPromise<Array<InlineResponse20018>>;
};
/**
...
export declare class OrderApi extends BaseAPI {
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrderOrderIdDelete(accountId: string, orderId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20021>>;
    /**
     * Modifies an open order. Must call /iserver/accounts endpoint prior to modifying an order. Use /iservers/account/orders endpoint to review open-order(s).
     * @summary Modify Order
     * @param {string} accountId account id, or fa group if modifying a group order
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrderOrderIdPost(accountId: string, orderId: string, body: ModifyOrder, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20020[]>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders, just pass one order in the array, the order structure will be same. Please note here, sometimes this endpoint alone can\'t make sure you submit the order successfully, you could receive some questions in the response, you have to to answer them in order to submit the order successfully. You can use \"/iserver/reply/{replyid}\" endpoint to answer questions
     * @summary Place Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrderPost(accountId: string, body: OrderRequest, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20017[]>>;
    /**
     * This end-point is going to be deprecated, you can use /iserver/account/{accountId}/orders/whatif, just pass one order in the array, the order structure will be same. This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response.
     * @summary Preview Order (Deprecated)
     * @param {string} accountId account id
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrderWhatifPost(accountId: string, body: OrderRequest, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20019>>;
    /**
     * You can pass a list of orders here such as bracket and OCA orders. Notes for OCA(one cancel all orders) orders: 1. if one order in the group is filled/cancelled, all the others in the same group will be cancelled. 2. To create OCA orders, please set isSingleGroup to true in each order 3. All orders in the same group will have same oca_group_id, you can get oca_group_id from /iserver/account/order/status/{orderId} end-point after orders are placed successfully
     * @summary Place Orders
     * @param {string} accountId account id
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrdersPost(accountId: string, body: InlineObject5, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20017[]>>;
    /**
     * This endpoint allows you to preview order without actually submitting the order and you can get commission information in the response. Also supports bracket orders.
     * @summary Preview Orders
     * @param {string} accountId account id
     ...
     * @memberof OrderApi
     */
    iserverAccountAccountIdOrdersWhatifPost(accountId: string, body: InlineObject7, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20019>>;
    /**
     *
     * @summary Order Status
     * @param {string} orderId Customer order id, use /iservers/account/orders endpoint to query orderId.
     ...
     * @memberof OrderApi
     */
    iserverAccountOrderStatusOrderIdGet(orderId: string, options?: any): Promise<import("axios").AxiosResponse<OrderStatus>>;
    /**
     * Financial Advisors can use this endpoint to place an order for a specified group. To place an order for a specified account use the endpoint /iserver/account/{accountId}/order. More information about groups can be found in the [TWS Users\' Guide:](https://guides.interactivebrokers.com/twsguide/twsguide.htm#usersguidebook/financialadvisors/create_an_account_group_for_share_allocation.htm).
     * @summary Place Orders for FA
     * @param {string} faGroup financial advisor group
     ...
     * @memberof OrderApi
     */
    iserverAccountOrdersFaGroupPost(faGroup: string, body: OrderRequest, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20017[]>>;
    /**
     * The endpoint is meant to be used in polling mode, e.g. requesting every x seconds. The response will contain two objects, one is notification, the other is orders. Orders is the list of live orders (cancelled, filled, submitted). Notifications contains information about execute orders as they happen, see status field. To receive streaming live orders the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Live Orders
     * @param {InlineObject4} [body]
     ...
     * @memberof OrderApi
     */
    iserverAccountOrdersGet(body?: InlineObject4, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20016>>;
    /**
     * Reply to questions when placing orders and submit orders
     * @summary Place Order Reply
     * @param {string} replyid Please use the \&quot;id\&quot; from the response of \&quot;Place Order\&quot; endpoint
     ...
     * @memberof OrderApi
     */
    iserverReplyReplyidPost(replyid: string, body: InlineObject6, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20018[]>>;
}
/**
 * PnLApi - axios parameter creator
 * @export
 */
export declare const PnLApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     * Returns an object containing PnL for the selected account and its models (if any). To receive streaming PnL the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary PnL for the selected account
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export declare const PnLApiFp: (configuration?: Configuration) => {
    /**
     * Returns an object containing PnL for the selected account and its models (if any). To receive streaming PnL the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary PnL for the selected account
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export declare const PnLApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns an object containing PnL for the selected account and its models (if any). To receive streaming PnL the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary PnL for the selected account
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class PnLApi extends BaseAPI {
    /**
     * Returns an object containing PnL for the selected account and its models (if any). To receive streaming PnL the endpoint /ws can be used. Refer to [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary PnL for the selected account
     * @param {*} [options] Override http request option.
...
export declare const PortfolioApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdAllocationGet: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionConidGet: (accountId: string, conid: number, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionsInvalidatePost: (accountId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionsPageIdGet: (accountId: string, pageId: string, model?: string, sort?: string, direction?: string, period?: string, options?: any) => Promise<RequestArgs>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAllocationPost: (body: InlineObject10, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    portfolioPositionsConidGet: (conid: number, options?: any) => Promise<RequestArgs>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
...
export declare const PortfolioApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdAllocationGet(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionConidGet(accountId: string, conid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     *
     * @summary Invalidates the backend cache of the Portfolio
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionsInvalidatePost(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Returns a list of positions for the given account. The endpoint supports paging, page\'s default size is 30 positions. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Portfolio Positions
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionsPageIdGet(accountId: string, pageId: string, model?: string, sort?: string, direction?: string, period?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAllocationPost(body: InlineObject10, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>>;
    /**
     * Returns an object of all positions matching the conid for all the selected accounts. For portfolio models the conid could be in more than one model, returning an array with the name of the model it belongs to. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Positions by Conid
     * @param {number} conid contract id
     ...
     * @throws {RequiredError}
     */
    portfolioPositionsConidGet(conid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20037>>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
...
export declare const PortfolioApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdAllocationGet(accountId: string, options?: any): AxiosPromise<Array<object>>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionConidGet(accountId: string, conid: number, options?: any): AxiosPromise<Array<object>>;
    /**
     *
     * @summary Invalidates the backend cache of the Portfolio
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAccountIdPositionsPageIdGet(accountId: string, pageId: string, model?: string, sort?: string, direction?: string, period?: string, options?: any): AxiosPromise<Array<object>>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @throws {RequiredError}
     */
    portfolioAllocationPost(body: InlineObject10, options?: any): AxiosPromise<Array<object>>;
    /**
     * Returns an object of all positions matching the conid for all the selected accounts. For portfolio models the conid could be in more than one model, returning an array with the name of the model it belongs to. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Positions by Conid
     * @param {number} conid contract id
     ...
     * @throws {RequiredError}
     */
    portfolioPositionsConidGet(conid: number, options?: any): AxiosPromise<InlineResponse20037>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
...
export declare class PortfolioApi extends BaseAPI {
     ...
     */
    portfolioAccountIdAllocationGet(accountId: string, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     * Information regarding settled cash, cash balances, etc. in the account\'s base currency and any other cash balances hold in other currencies.  /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint. The list of supported currencies is available at https://www.interactivebrokers.com/en/index.php?f=3185.
     * @summary Account Ledger
     * @param {string} accountId account id
     ...
     * @memberof PortfolioApi
     */
    portfolioAccountIdPositionConidGet(accountId: string, conid: number, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     *
     * @summary Invalidates the backend cache of the Portfolio
     * @param {string} accountId account id
     ...
     * @memberof PortfolioApi
     */
    portfolioAccountIdPositionsInvalidatePost(accountId: string, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Returns a list of positions for the given account. The endpoint supports paging, page\'s default size is 30 positions. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Portfolio Positions
     * @param {string} accountId account id
     ...
     * @memberof PortfolioApi
     */
    portfolioAccountIdPositionsPageIdGet(accountId: string, pageId: string, model?: string, sort?: string, direction?: string, period?: string, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     * Returns information about margin, cash balances and other information related to specified account. See also /portfolio/{accountId}/ledger. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Account Summary
     * @param {string} accountId account id
     ...
     * @memberof PortfolioApi
     */
    portfolioAllocationPost(body: InlineObject10, options?: any): Promise<import("axios").AxiosResponse<object[]>>;
    /**
     * Returns an object of all positions matching the conid for all the selected accounts. For portfolio models the conid could be in more than one model, returning an array with the name of the model it belongs to. /portfolio/accounts or /portfolio/subaccounts must be called prior to this endpoint.
     * @summary Positions by Conid
     * @param {number} conid contract id
     ...
     * @memberof PortfolioApi
     */
    portfolioPositionsConidGet(conid: number, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20037>>;
    /**
     * Used in tiered account structures (such as financial advisor and ibroker accounts)  to return a list of sub-accounts for which the user can view position and  account-related information. This endpoint must be called prior to calling other  /portfolio endpoints for those subaccounts.  To query a list of accounts the user can trade, see /iserver/accounts.
     * @summary List of Sub-Accounts
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export declare const PortfolioAnalystApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    paPerformancePost: (body: InlineObject11, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    paSummaryPost: (body: InlineObject12, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    paTransactionsPost: (body: InlineObject13, options?: any) => Promise<RequestArgs>;
};
/**
 * PortfolioAnalystApi - functional programming interface
 * @export
 */
export declare const PortfolioAnalystApiFp: (configuration?: Configuration) => {
    /**
     * Returns the performance (MTM) for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Performance
     * @param {InlineObject11} body
     ...
     * @throws {RequiredError}
     */
    paPerformancePost(body: InlineObject11, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Performance>>;
    /**
     * Returns a summary of all account balances for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Balance\'s Summary
     * @param {InlineObject12} body
     ...
     * @throws {RequiredError}
     */
    paSummaryPost(body: InlineObject12, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Summary>>;
    /**
     * transaction history for a given number of conids and accounts. Types of transactions include dividend payments, buy and sell transactions, transfers.
     * @summary Position\'s Transaction History
     * @param {InlineObject13} body
     ...
     * @throws {RequiredError}
     */
    paTransactionsPost(body: InlineObject13, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transactions>>;
};
/**
 * PortfolioAnalystApi - factory interface
 * @export
 */
export declare const PortfolioAnalystApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns the performance (MTM) for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Performance
     * @param {InlineObject11} body
     ...
     * @throws {RequiredError}
     */
    paPerformancePost(body: InlineObject11, options?: any): AxiosPromise<Performance>;
    /**
     * Returns a summary of all account balances for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Balance\'s Summary
     * @param {InlineObject12} body
     ...
     * @throws {RequiredError}
     */
    paTransactionsPost(body: InlineObject13, options?: any): AxiosPromise<Transactions>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class PortfolioAnalystApi extends BaseAPI {
    /**
     * Returns the performance (MTM) for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Performance
     * @param {InlineObject11} body
     ...
     */
    paPerformancePost(body: InlineObject11, options?: any): Promise<import("axios").AxiosResponse<Performance>>;
    /**
     * Returns a summary of all account balances for the given accounts, if more than one account is passed, the result is consolidated.
     * @summary Account Balance\'s Summary
     * @param {InlineObject12} body
     ...
     * @memberof PortfolioAnalystApi
     */
    paSummaryPost(body: InlineObject12, options?: any): Promise<import("axios").AxiosResponse<Summary>>;
    /**
     * transaction history for a given number of conids and accounts. Types of transactions include dividend payments, buy and sell transactions, transfers.
     * @summary Position\'s Transaction History
     * @param {InlineObject13} body
     ...
     * @memberof PortfolioAnalystApi
     */
    paTransactionsPost(body: InlineObject13, options?: any): Promise<import("axios").AxiosResponse<Transactions>>;
}
/**
 * ScannerApi - axios parameter creator
 * @export
 */
export declare const ScannerApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    iserverScannerParamsGet: (options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    iserverScannerRunPost: (body: ScannerParams, options?: any) => Promise<RequestArgs>;
};
/**
 * ScannerApi - functional programming interface
 * @export
 */
export declare const ScannerApiFp: (configuration?: Configuration) => {
    /**
     * Returns an object contains four lists contain all parameters for scanners
     * @summary Scanner Parameters
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverScannerParamsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20029>>;
    /**
     *
     * @summary run scanner to get a list of contracts
     * @param {ScannerParams} body scanner-params request
     ...
     * @throws {RequiredError}
     */
    iserverScannerRunPost(body: ScannerParams, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse20030>>>;
};
/**
 * ScannerApi - factory interface
 * @export
 */
export declare const ScannerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns an object contains four lists contain all parameters for scanners
     * @summary Scanner Parameters
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    iserverScannerRunPost(body: ScannerParams, options?: any): AxiosPromise<Array<InlineResponse20030>>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class ScannerApi extends BaseAPI {
    /**
     * Returns an object contains four lists contain all parameters for scanners
     * @summary Scanner Parameters
     * @param {*} [options] Override http request option.
     ...
     * @memberof ScannerApi
     */
    iserverScannerParamsGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20029>>;
    /**
     *
     * @summary run scanner to get a list of contracts
     * @param {ScannerParams} body scanner-params request
     ...
     * @memberof ScannerApi
     */
    iserverScannerRunPost(body: ScannerParams, options?: any): Promise<import("axios").AxiosResponse<InlineResponse20030[]>>;
}
/**
...
export declare const SessionApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAuthStatusPost: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    iserverReauthenticatePost: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    logoutPost: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ssoValidateGet: (options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    ticklePost: (options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const SessionApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAuthStatusPost(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthStatus>>;
    /**
     * When using the CP Gateway, this endpoint provides a way to reauthenticate to the Brokerage system as long as there is a valid SSO session, see /sso/validate.
     * @summary Tries to re-authenticate to Brokerage
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    iserverReauthenticatePost(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthStatus>>;
    /**
     * Logs the user out of the gateway session. Any further activity requires re-authentication.
     * @summary Ends the current session
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    logoutPost(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>>;
    /**
     * Validates the current session for the SSO user
     * @summary Validate SSO
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ssoValidateGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20038>>;
    /**
     * If the gateway has not received any requests for several minutes an open session will automatically timeout. The tickle endpoint pings the server to prevent the session from ending.
     * @summary Ping the server to keep the session open
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    ticklePost(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
...
export declare class SessionApi extends BaseAPI {
     ...
     * @memberof SessionApi
     */
    iserverAuthStatusPost(options?: any): Promise<import("axios").AxiosResponse<AuthStatus>>;
    /**
     * When using the CP Gateway, this endpoint provides a way to reauthenticate to the Brokerage system as long as there is a valid SSO session, see /sso/validate.
     * @summary Tries to re-authenticate to Brokerage
     * @param {*} [options] Override http request option.
     ...
     * @memberof SessionApi
     */
    iserverReauthenticatePost(options?: any): Promise<import("axios").AxiosResponse<AuthStatus>>;
    /**
     * Logs the user out of the gateway session. Any further activity requires re-authentication.
     * @summary Ends the current session
     * @param {*} [options] Override http request option.
     ...
     * @memberof SessionApi
     */
    logoutPost(options?: any): Promise<import("axios").AxiosResponse<InlineResponse200>>;
    /**
     * Validates the current session for the SSO user
     * @summary Validate SSO
     * @param {*} [options] Override http request option.
     ...
     * @memberof SessionApi
     */
    ssoValidateGet(options?: any): Promise<import("axios").AxiosResponse<InlineResponse20038>>;
    /**
     * If the gateway has not received any requests for several minutes an open session will automatically timeout. The tickle endpoint pings the server to prevent the session from ending.
     * @summary Ping the server to keep the session open
     * @param {*} [options] Override http request option.
     ...
     * @memberof SessionApi
     */
    ticklePost(options?: any): Promise<import("axios").AxiosResponse<void>>;
}
/**
 * StreamingApi - axios parameter creator
 * @export
 */
export declare const StreamingApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    wsPost: (options?: any) => Promise<RequestArgs>;
};
/**
 * StreamingApi - functional programming interface
 * @export
 */
export declare const StreamingApiFp: (configuration?: Configuration) => {
    /**
     * The streaming API is documented under [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Websocket Endpoint
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    wsPost(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
 * StreamingApi - factory interface
 * @export
 */
export declare const StreamingApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * The streaming API is documented under [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Websocket Endpoint
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class StreamingApi extends BaseAPI {
    /**
     * The streaming API is documented under [Streaming WebSocket Data](https://interactivebrokers.github.io/cpwebapi/RealtimeSubscription.html) for details.
     * @summary Websocket Endpoint
     * @param {*} [options] Override http request option.
     ...
     */
    wsPost(options?: any): Promise<import("axios").AxiosResponse<void>>;
}
/**
...
export declare const TradesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountTradesGet: (options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const TradesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    iserverAccountTradesGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Trade>>>;
};
/**
...
export declare class TradesApi extends BaseAPI {
     ...
     * @memberof TradesApi
     */
    iserverAccountTradesGet(options?: any): Promise<import("axios").AxiosResponse<Trade[]>>;
}
